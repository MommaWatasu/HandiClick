...
void btc_gap_ble_call_handler(btc_msg_t *msg)
{
    ...
    case BTC_GAP_BLE_ADD_BOND_DEV_EVT: {
        BD_ADDR bd_addr;
        memcpy(bd_addr, arg->add_bond_device.bd_addr, sizeof(BD_ADDR));
        BTA_DmAddDevice(
            bd_addr,
            arg->add_bond_device.dev_class,
            arg->add_bond_device.link_key,
            arg->add_bond_device.trusted_mask,
            arg->add_bond_device.is_trusted,
            arg->add_bond_device.key_type,
            arg->add_bond_device.io_cap,
            arg->add_bond_device.pin_length,
            arg->add_bond_device.sc_support
            );
        break;
    }
